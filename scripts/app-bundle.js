define('app',['exports', './environment', 'aurelia-fetch-client'], function (exports, _environment, _aureliaFetchClient) {
  'use strict';
  ...
  var App = exports.App = function () {
    ...
    App.prototype.activate = function activate() {
      ...
      var jsonFile = _environment2.default.urlRootPath + 'config.json';
      var listServer = new Array();
      client.fetch(jsonFile).then(function (response) {
    ...
    App.prototype.configureRouter = function configureRouter(config, router) {
      ...
      config.options.root = _environment2.default.urlRootPath;
...
define('nav-bar',['exports', 'aurelia-framework'], function (exports, _aureliaFramework) {
  ...
  var NavBar = exports.NavBar = (_class = function () {
    ...
    NavBar.prototype.siriProfileChanged = function siriProfileChanged(newVal) {
      ...
      if (newVal == 'siri-lite') $('[data-hide-for="siri-lite"]').hide();else $('[data-hide-for="siri-lite"]').show();
      localStorage.setItem('autoCompleteAlready', false);
...
define('right-panel',["exports", "tools"], function (exports, _tools) {
  ...
  var RightPanel = exports.RightPanel = function () {
    ...
    RightPanel.prototype.stopMonitoring = function stopMonitoring() {
      ...
      request.sendRequest(xmlRequest, request.handleStopMonitoringResponse, responseCard, $('#stop-monitoring-form-wrapper'), 'stop-monitoring');
    };
    ...
    RightPanel.prototype.generalMessage = function generalMessage() {
      ...
      var responseCard = new stopMonitoringCard();
      request.sendRequest(generalMessageRequest, request.handleGeneralMessageResponse, responseCard, $('#get-general-message-form-wrapper'), 'general-message');
    };
    ...
    RightPanel.prototype.stopDiscovery = function stopDiscovery() {
      ...
      var responseCard = new stopMonitoringCard();
      request.sendRequest(stopDscRequest, request.handleStopDiscoveryResponseDisplay, responseCard, $('#service-discovery-form-wrapper'), 'stoppoints-discovery');
    };
    ...
    RightPanel.prototype.lineDiscovery = function lineDiscovery() {
      ...
      var responseCard = new stopMonitoringCard();
      request.sendRequest(lineDscRequest, request.handleLineDiscoveryResponseDisplay, responseCard, $('#service-discovery-form-wrapper'), 'lines-discovery');
    };
    ...
    RightPanel.prototype.checkStatus = function checkStatus() {
      ...
      var responseCard = new stopMonitoringCard();
      request.sendRequest(checkStatusRequest, request.handleCheckStatusResponse, responseCard, $('#check-status-form-wrapper'), 'checkstatus');
    };
